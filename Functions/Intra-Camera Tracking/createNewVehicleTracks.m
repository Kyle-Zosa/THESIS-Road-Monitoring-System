function [vehicleTracks, nextId] = createNewVehicleTracks(vehicleTracks, vehicleClassifier, nextId, unassignedDetections, frame, centroids, bboxes, kConfig, location, time, outputHandler)
